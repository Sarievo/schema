...
void f() {
    ...
    /* 
    you're given two subsequences of a.
    arrange them in a way, such that the max of the prefix array of a is maximized.
    find that max.

    find the maximum_prefix in a, and the maximum_prefix in b, add them together
     */
    int sum_a = maximum_prefix(a);
    int sum_b = maximum_prefix(b);
