/** 
 * Sarievo.
 * URL: https://codeforces.com/contest/1701/problem/0
 */
...
void solve() {
    /* 
    you can choose one row and one col, and clear row x or col y
     */
    vc<bool> row_has_grass(2,false);
    vc<bool> col_has_grass(2,false);
    int sum = 0;
    int value;
    rep(i,2) {
        rep(j,2) {
