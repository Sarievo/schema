...
void f() {
    ...
    AB, BC, AC
    ABC
    let ABC cmp AB+C, BC+A, AC+B, and finaly A+B+C
     */
    ...
    // for(auto&p:costs) cout << p.a << ":" << p.b << endl;

    if (costs.count("AB")&&costs.count("C"))
        chmin(ABC,costs["AB"]+costs["C"]);
    if (costs.count("BC")&&costs.count("A"))
        chmin(ABC,costs["BC"]+costs["A"]);
    if (costs.count("AC")&&costs.count("B"))
        chmin(ABC,costs["AC"]+costs["B"]);
    if (costs.count("A")&&costs.count("B")&&costs.count("C"))
        chmin(ABC,costs["A"]+costs["B"]+costs["C"]);
