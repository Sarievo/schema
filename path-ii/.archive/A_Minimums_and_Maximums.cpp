...
inline bool read() {
    ...
    forn(i, t) {
        cin >> l1 >> l2 >> r1 >> r2;
        v.push_back(vector<int>{l1, l2, r1, r2});
    }
...
void solve() {
    forn(i, t) {
        ...
        /* 
        if max(l1, r1) <= min(l2, r2)
        at most max(l1, r1) elements can be both minimum and maximum
        else, l1 + r1 can be minimums and maximums
         */
    }
}
